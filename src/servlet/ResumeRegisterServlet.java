...
/**
 * Servlet implementation class ResumeRegisterServlet
 */
@WebServlet("/ResumeRegisterServlet")
public class ResumeRegisterServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ResumeRegisterServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String sysdtl = request.getParameter("sysdtl");
		String roles = request.getParameter("roles");
		String tools = request.getParameter("tools");

		SqlDao sql = new SqlDao();

		//業務経歴情報を登録するメソッドの呼び出し
		sql.insert_career_info(employeeId,startdate,enddate,sysname,sysdtl,roles,tools);
